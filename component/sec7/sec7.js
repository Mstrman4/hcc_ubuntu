...
let list =[
  ...
  { link:"https://mitadent.ir/" ,img:"img/dandon.png", title:" دندان پزشکی میتادنت" , des:"ما در تلاش هستیم تا با استفاده از کادر مجرب و کارآموزده خود و همچنین بهره گیری از بروزترین و امکانات و خدماتی درجه یک را به شما عزیزان ارائه دهیم"},
  { link:"https://mitadent.ir/" ,img:"img/dandon.png", title:" دندان پزشکی میتادنت" , des:"ما در تلاش هستیم تا با استفاده از کادر مجرب و کارآموزده خود و همچنین بهره گیری از بروزترین و امکانات و خدماتی درجه یک را به شما عزیزان ارائه دهیم"},
  { link:"https://mitadent.ir/" ,img:"img/dandon.png", title:" دندان پزشکی عباس" , des:"ما در تلاش هستیم تا با استفاده از کادر مجرب و کارآموزده خود و همچنین بهره گیری از بروزترین و امکانات و خدماتی درجه یک را به شما عزیزان ارائه دهیم"},
