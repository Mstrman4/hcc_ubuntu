...
let listOf = [
    {extraIMG:"../img/arash.png", name:"ارش", nikname:"باهری", datauser:"فعال و علاقه مند به حوزه تکنولوژی و مدافع نرم افزار آزاد",titleera:"کارگاه", era:"پیاده‌سازی مانیتوریگ با prometheus در محیط‌های شخصی",miniimg:"../img/mini-arash.png"},
    {extraIMG:"../img/melika.png", name:"ملیکا ", nikname:"قدیری", datauser:"ملیکا قدیریفعال در حوزه تحلیل و طراحی محصول. علاقمند به کاربرپژوهی و بررسی رفتار کاربر در کار با اپلیکیشن‌ها",titleera:"تحلیل ui/ux اوبنتو", era:"تحلیل رابط کاربری اوبنتو 24.04",miniimg:"../img/mini-mlika.png"},
    ...
    {extraIMG:"../img/mmd.png", name:"محمد ", nikname:"مزارعی", datauser:"توسعه دهنده سفت‌افزار، طراح و توسعه دهنده سیستم‌های امبدد با و بدون سیستم عامل، علاقه‌مند به حوزه رادیو‌آماتوری و هم بنیانگذار وب سایت سیسوگ (مرجع متن باز آموزش الکترونیک) ",titleera:"بررسی و شبیه سازی حمله gps spoofing ", era:"بررسی روش های حمله gps spoofing و شبیه سازی حمله با استفاده از ابزارهای متن باز ",miniimg:"../img/mini-r3.png"},
