...
let listOf = [
    ...
    {extraIMG:"../img/mmd.png", name:"ممد", nikname:"", datauser:"امیرعماد میرمیرانی (زادهٔ ۲۵ دی ۱۳۵۶) که با نام مستعار جادی شناخته می‌شود، برنامه‌نویس ، هکر ، گیک ، فعال حوزهٔ تکنولوژی‌های جدید و جامعهٔ نرم‌افزار آزاد و متن‌باز و وبلاگ‌نویس اهل ایران است. او مجری پادکستی با عنوان «رادیو گیک» است که بعداً نامش به «رادیو جادی» تغییر یافت.",titleera:"از این اوبونتو تا اون اوبونتو", era:"آپدیت جدید اوبنتو و تغییرات آن",miniimg:"../img/mini-r3.png"},
...
this.className="m-auto"
                ...
                listOf.forEach((data)=>{
                    ...
                    <div class="content flex flex-col md:flex-row   ">
                        ...
                        <div class="img  order-1 md:order-2 md:w-4/12">
